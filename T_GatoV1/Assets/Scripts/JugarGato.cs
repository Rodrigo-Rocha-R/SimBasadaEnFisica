...
public class Tablero : MonoBehaviour
{
    ...
    GameObject linea;
    GameObject Piso;
    GameObject Fg_jugador;

    public Material m_piso;
    public Material m_tablero;
    ...
    void CreatePiso()
    {
        ...
        MeshRenderer mr2 = Piso.gameObject.GetComponent<MeshRenderer>();
        mr2.material = m_tablero;

        Rigidbody rigidbody = mr.gameObject.AddComponent<Rigidbody>();
        rigidbody.mass = 20;
    ...
    void CrearObjeto(List<List<int>> posicion_gato, int fila, int columna)
    {
        ...
        if(posicion_gato[fila][columna] == 0)
        {
            ...
            Fg_jugador = Instantiate(player1);
        }

        if(posicion_gato[fila][columna] == 1)
        {
            Fg_jugador = Instantiate(player2);
        }

        // La posicion de donde se va a tirar el objeto
        Rigidbody rigidbody = Fg_jugador.gameObject.AddComponent<Rigidbody>();
        rigidbody.mass = 5;
        ...
        if (fila == 0)
        {
            if(columna == 0)
            {
                Fg_jugador.transform.position = new Vector3(-2.4f, 5, 2.4f);

            }
            
            if(columna == 1)
            {
                Fg_jugador.transform.position = new Vector3(0, 5, 2.4f);
            }
        ...
        if(fila == 1)
        {
            if (columna == 0)
            {
                Fg_jugador.transform.position = new Vector3(-2.3f, 5, 0);
            }

            if (columna == 1)
            {
                Fg_jugador.transform.position = new Vector3(0, 5, 0);
            }
        ...
        if(fila == 2)
        {
            if (columna == 0)
            {
                Fg_jugador.transform.position = new Vector3(-2.3f, 5, -2);
            }

            if (columna == 1)
            {
                Fg_jugador.transform.position = new Vector3(0, 5, -2);
            }
